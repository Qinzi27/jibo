...
const CACHE = "lean-crew-79ab1a850113";
const ASSETS = ["./", "./index.html", "./styles.css", "./core.js", "./exercises.js", "./plans.js", "./app.js", "./manifest.webmanifest", "./assets/biceps-curl.svg", "./assets/calf-raise.svg", "./assets/chest-press.svg", "./assets/dead-bug.svg", "./assets/dumbbell-row.svg", "./assets/glute-bridge.svg", "./assets/goblet-squat.svg", "./assets/hero.svg", "./assets/icon-192.png", "./assets/icon-512.png", "./assets/icon.svg", "./assets/lat-pulldown.svg", "./assets/lateral-raise.svg", "./assets/leg-curl.svg", "./assets/leg-press.svg", "./assets/plank.svg", "./assets/push-up.svg", "./assets/reverse-lunge.svg", "./assets/seated-row.svg", "./assets/shoulder-press.svg", "./assets/triceps-pushdown.svg"];
